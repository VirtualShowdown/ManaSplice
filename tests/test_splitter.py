...
from manasplice.exceptions import FunctionExtractionError
from manasplice.resolver import parse_target, resolve_target
from manasplice.splitter import split_function
...
def test_split_function_in_package_module(tmp_path: Path) -> None:
    ...
    extracted = result.new_module_file.read_text(encoding="utf-8")
    assert '"""Auto-generated by ManaSplice from service.py."""' in extracted
